      ...
      if (res.ok) {
        ...
        if (payload.newBalance !== undefined) {
          setData(prev => prev ? {
            ...
            transactions: [
              { id: 'tx_' + Date.now(), description: 'BMONI cNGN Smart Wallet Deposit', amount, type: 'credit', createdAt: new Date().toISOString() },
              ...prev.transactions
            ]
          } : null);
          setShowSuccess(true);
        ...
        <div className="page-header animate-fade-up" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem', marginBottom: '2rem' }}>
          <div>
            <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '1.75rem', fontWeight: 800, margin: 0, color: 'var(--text)' }}>
              BMONI Smart Wallet & Billing
            </h1>
            <p style={{ fontSize: '0.82rem', color: 'var(--text-3)', marginTop: '0.25rem' }}>
              Embedded on-chain CNGN wallet balances, NGN virtual deposit accounts, and bank offramps.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gap: '1.5rem' }}>
            ...
            <div className="pricing-card" style={{
              ...
              <div style={{ display: 'flex', gap: '0.5rem', marginTop: '1.5rem', fontSize: '0.76rem', color: 'rgba(255,255,255,0.45)' }}>
                ...
                <span>Smart wallet transfers complete instantly in-chat without payment redirect links.</span>
              </div>
            </div>
            ...
            <div className="card" style={{ padding: '1.5rem', overflow: 'hidden' }}>
              ...
              {loading ? (
                ...
                <div className="empty-state" style={{ padding: '3rem 1.5rem' }}>
                  ...
                  <p style={{ fontWeight: 800, fontSize: '0.9rem', color: 'var(--text-2)' }}>No BMONI transactions yet</p>
                  <p style={{ fontSize: '0.75rem', color: 'var(--text-3)' }}>Transfers and offramps will appear here.</p>
                </div>
              ) : (
          ...
          <div style={{ display: 'grid', gap: '1.5rem' }}>
            ...
            <div className="card" style={{ padding: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                ...
                <h2 style={{ fontSize: '0.95rem', fontWeight: 800, margin: 0 }}>Add BMONI Credits</h2>
              </div>
              <form onSubmit={handleTopUp} style={{ display: 'grid', gap: '1rem' }}>
                ...
                {showSuccess && (
                  <div className="success-panel" style={{ padding: '0.75rem' }}>
                    ...
                    <p style={{ fontSize: '0.8rem' }}>BMONI CNGN Wallet credited successfully!</p>
                  </div>
                )}
                ...
                <button type="submit" className="btn-primary" disabled={topUpLoading} style={{ padding: '0.75rem' }}>
                  ...
                  {topUpLoading ? 'Processing BMONI Rail...' : 'Top Up via BMONI Virtual Account'}
                </button>
              </form>
            </div>
