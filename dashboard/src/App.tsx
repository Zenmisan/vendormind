      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/how-it-works" element={<LegalPage kind="how-it-works" />} />
            <Route path="/features" element={<LegalPage kind="features" />} />
            <Route path="/pricing" element={<LegalPage kind="pricing" />} />
            <Route path="/about" element={<LegalPage kind="about" />} />
            <Route path="/blog" element={<LegalPage kind="blog" />} />
